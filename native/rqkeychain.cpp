...
QObject *RQKeychain::qmlInstance(QQmlEngine *engine, QJSEngine *scriptEngine)
{
  Q_UNUSED(scriptEngine)

  RQKeychain *keychain = new RQKeychain();
  return keychain;
}
...
{
  qmlRegisterSingletonType<RQKeychain>("ReactQML", 1, 0, "RQKeychain", &RQKeychain::qmlInstance);
}
